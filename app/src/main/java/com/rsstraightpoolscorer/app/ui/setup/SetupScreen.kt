package com.rsstraightpoolscorer.app.ui.setup
...
import com.rsstraightpoolscorer.app.data.MatchScheduleRow
import com.rsstraightpoolscorer.app.data.PlayersRepoV2
import com.rsstraightpoolscorer.app.data.loadMatchScheduleFromAssets
...
fun SetupScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        // Load schedule
        schedule = try {
            loadMatchScheduleFromAssets(ctx, "remote/matches_3.csv")
        } catch (_: Throwable) {
            emptyList()
        }
