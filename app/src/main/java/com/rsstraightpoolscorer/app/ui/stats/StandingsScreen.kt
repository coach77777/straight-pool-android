...
fun StandingsScreen(
    ...
    val matchesRepo = remember { com.rsstraightpoolscorer.app.data.MatchesRepository(ctx) }
    var matches by remember { mutableStateOf<List<com.rsstraightpoolscorer.app.data.LeagueMatch>>(emptyList()) }
